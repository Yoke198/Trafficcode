$(document).ready(function(){
	...
	for(var l4=0;l4<3;l4++){
		...
		},l4*38000)//重复触发时间=红灯+绿灯+黄灯等待时间之和
	}	
	...
	for(var lr4=0;lr4<3;lr4++){
		...
		},lr4*38000)//重复触发时间=红灯+绿灯+黄灯等待时间之和
	}	
