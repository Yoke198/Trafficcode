...
public class CrossRoadModel {
	...
	private long totalCrossroadCount;//总记录数(路口总数)
	...
	public long getTotalCrossroadCount() {
		return totalCrossroadCount;
	}
	public void setTotalCrossroadCount(long totalCrossroadCount) {
		this.totalCrossroadCount = totalCrossroadCount;
	}
